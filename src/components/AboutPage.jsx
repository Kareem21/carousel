                    ...
                    <div className="about">
                        ...
                        <div className="story-grid">
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        ...
                                        antique carousels and carousel art.      The second experience came during a 1972 visit to the antique
                            ...
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        ...
                                        Inspired by her initial purchase, Mrs. Dinger soon tracked down what she realized was a treasure trove of two dozen carousel horses.
                                        They were stacked like so much firewood in a Philadelphia warehouse. Their next destination was the Dinger's garage.
                                        By this time Charlotte Dinger was in full swing. Figures that had been stripped from thousands of carousels from the turn of the
                            ...
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        Her husband Carl, only mildly irritated at the loss of space for the family cars,
                                        could hardly complain. He, too, was a collector, but then again his collection of baseball
                                        cards did not require repeated additions to the couple's home.
                                        Over the next two decades Mrs. Dinger tracked down, bought and restored scores of horses, and other carousel figures.
                                        She became familiar with the history of the American carousel, from its beginnings in 1867 with the work of a German immigrant,
                            ...
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        ...
                                        Later she became a consultant to Sothebys, and also started her own publishing company to produce the definitive coffee table book,
                                        " ART OF THE CAROUSEL ". When her collection threatened to outstrip the capacity of her home,
                                        she put together a traveling exhibition that was on display at museums across the country.
                                    </p>
                                </div>
                                <img src="/Aboutus/blackwhite.jpg" alt="Carousel"/>
                            </div>
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        Other collectors, recognized that antique carousel figures were not merely curiosities, but examples of
                                        an important American folk art. The prices of choice specimens soared to astronomical levels, as much  as
                                        ...
                                        Anyone who hasnt seen some of this collection in person, may have caught a glimpse of a few of
                                        her prize pieces in the family mail. The United  States Postal Service has twice used Mrs.  Dinger's
                                        collection as the basis for an issue of  commemorative stamps depicting carousel animals. Despite her interest in
                                        collecting individual carousel figures, Mrs. Dinger campaigned to keep the  dwindling supply of working carousels intact. ( According to the American Carousel Society, which estimates there were once 3,000 to 6,000 carousels in the country, from the famous Flying Horses on Marthas Vineyard, where children still ride on the oldest American carousel, assembled in 1884, to the  last carousels produced in the1920s.) There are now only 133 left.
                                    </p>
                                </div>
                            </div>
                            <div className="story-item">
                                <div className="text-content">
                                    <p>
                                        With all her instincts as a collector, and her appreciation of carousels and carousel art,
                                        she has preserved a legacy for the future. Charlotte Dinger did realized her
                                        childhood dream The Fairy Tale Experience Of Whirling Around On A Beautiful Carousel.
                                    </p>
                                </div>
                                <img src="/Aboutus/blackwhite.jpg" alt="Carousel"/>
                            </div>
